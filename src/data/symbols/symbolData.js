...
export const authenticSymbols = {
  cernium: {
    ...
    data: authenticSymbolUpgradeData.cernium
  },
  hotelArcus: {
    name: '飯店阿爾克斯',
    icon: Authentic_Symbol_2,
    data: authenticSymbolUpgradeData.hotelArcus
  },
  odium: {
    name: '奧迪溫',
    icon: Authentic_Symbol_3,
    data: authenticSymbolUpgradeData.odium
  },
  shangriLa: {
    name: '桃源境',
    icon: Authentic_Symbol_4,
    data: authenticSymbolUpgradeData.shangriLa
  },
  arteria: {
    name: '阿爾特利亞',
    icon: Authentic_Symbol_5,
    data: authenticSymbolUpgradeData.arteria
  },
  carcion: {
    name: '卡爾西溫',
    icon: Authentic_Symbol_6,
    data: authenticSymbolUpgradeData.carcion
  },
  tallahart: {
    name: '塔拉哈特',
    icon: Authentic_Symbol_7,
    data: authenticSymbolUpgradeData.tallahart
  }
};
