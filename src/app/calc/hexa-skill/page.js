              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center py-2 px-3 bg-muted/50 rounded-md">
                    <div className="flex items-center space-x-2">
                      <Image src={MATERIALS.solErda.icon} alt={MATERIALS.solErda.name} width={20} height={20} />
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center py-2 px-3 bg-muted/50 rounded-md">
                    <div className="flex items-center space-x-2">
                      <Image src={MATERIALS.solErdaFragment.icon} alt={MATERIALS.solErdaFragment.name} width={20} height={20} />
              ...
              <thead className="bg-muted/80 dark:bg-muted/60 sticky top-0">
                ...
                <tr className="border-b bg-muted/60 dark:bg-muted/40">
                  ...
                  <th className="py-2 px-1 text-xs font-medium">
                    <Image src={MATERIALS.solErda.icon} alt={MATERIALS.solErda.shortName} width={16} height={16} className="mx-auto" />
                  </th>
                  <th className="py-2 px-1 text-xs font-medium">
                    <Image src={MATERIALS.solErdaFragment.icon} alt={MATERIALS.solErdaFragment.shortName} width={16} height={16} className="mx-auto" />
                  </th>
                  <th className="py-2 px-1 text-xs font-medium">
                    <Image src={MATERIALS.solErda.icon} alt={MATERIALS.solErda.shortName} width={16} height={16} className="mx-auto" />
                  </th>
